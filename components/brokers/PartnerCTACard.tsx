...
export function PartnerCTACard() {
  ...
  return (
    <div className="min-h-[320px] text-logoborder border-dashed border-accent/30 rounded-xl flex flex-col items-center justify-center p-10 text-center gap-3 bg-surface">
